...
export const steps: { title: string; subtitle: string; questions: Question[] }[] = [
  ...
  { title: 'Qual é o tamanho da sua empresa?', subtitle: 'Essas informações ajudam a dimensionar sua estrutura.', questions: [
    { id: 'revenue', label: 'Qual é o faturamento médio mensal da empresa?', options: ['Até R$ 100 mil/mês', 'R$ 100 mil a R$ 300 mil/mês', 'R$ 300 mil a R$ 500 mil/mês', 'R$ 500 mil a R$ 1 milhão/mês', 'R$ 1 milhão a R$ 3 milhões/mês', 'R$ 3 milhões a R$ 10 milhões/mês', 'Acima de R$ 10 milhões/mês', 'Prefiro não informar'] },
  ...
  { title: 'Como é sua estrutura comercial?', subtitle: 'Queremos entender quem participa das suas vendas.', questions: [
    ...
    { id: 'representatives', label: 'Quantos representantes comerciais ou vendedores externos sua empresa possui?', options: ['Nenhum', '1 a 5', '6 a 15', '16 a 30', '31 a 50', 'Mais de 50'] }
  ]},
